...
INSERT INTO users (first_name, last_name, login, password, group_id, roles) values ('Bruce', 'Banner', 'hulk', '$2a$10$EOv4C4b69cJf1Jx9YCKLCe3No7Rui1CTywg6rFw5/i4yhHF/GIR2S', 2, 'STUDENT');
INSERT INTO users (first_name, last_name, login, password, group_id, roles) values ('Tony', 'Stark', 'ironman', '$2a$10$EOv4C4b69cJf1Jx9YCKLCe3No7Rui1CTywg6rFw5/i4yhHF/GIR2S', 3, 'STUDENT');
